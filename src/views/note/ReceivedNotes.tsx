...
import { GetReceiveNoteRequest } from '@/apis/note/get-receive-note.api';
...
function ReceivedNotes() {
    ...
    const fetchNotes = async () => {
      ...
      try {
        ...
        const response = await GetReceiveNoteRequest(token, page, 20);
            ...
            {loading ? (
                ...
                >
                  <div css={s.spans}>
                    ...
                    <span css={s.noteText}>{note.noteText}</span>
