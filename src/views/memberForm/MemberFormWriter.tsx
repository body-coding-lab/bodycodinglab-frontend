...
import * as m from "./MemberFormStyle";
...
const FormWriter = () => {
  ...
  const [form, setForm] = useState<PostMemberFormRequestDto>({
    bodyForm: null,
    goal: null,
    bmi: null,
    improvedPart: null,
  ...
  const renderRadioGroup = (
    label: string,
    name: keyof PostMemberFormRequestDto,
      ...
      <div css={m.formContainer}>
        ...
        <form>
          ...
          <div css={m.submitButtonContainer}>
            <button css={m.submitButton} type="button" onClick={handleSubmit}>
              제출하기
            </button>
          </div>
        </form>
