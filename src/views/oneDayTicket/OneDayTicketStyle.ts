...
export const issuedCard = css`
  background-color: #F2F9FF;
`;

export const usedCard = css`
  background-color: #F3FBF2;
`;

export const canceledCard = css`
  background-color: #FFF5F5;
`;

export const getCardByStatus = (status: string) => {
  switch (status) {
    case 'ISSUED':
      return issuedCard;
    case 'USED':
...
export const emptyTicketMessage = css`
  text-align: center;
  margin-top: 2rem;
  font-size: 1.2rem;
  color: #666;
