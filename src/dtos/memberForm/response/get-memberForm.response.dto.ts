...
type Improved_part = "CHEST" | "ARM" | "STOMACH" | "LEG" | "NOT_APPLICABLE";
type PreferredDiet = "VEGETARIAN" | "VEGAN" | "KITO" | "MEDITERRANEAN" | "CARNIVORE" | "NOT_APPLICABLE";
...
type ExerciseFrequency = "NEVER" | "WEEL_1TO2" | "WEEK_3" | "MORE_WEEK_3";
type InvestableTime = "MIN30" | 'MIN40' | "HOUR1" | "FREEDOM";

export interface GetMemberFormResponseDto{
  memberId: number;
  memberName: string;
  bodyForm: BodyForm;
  goal: Goal;
