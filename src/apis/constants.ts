...
const MATCH_WAITING_LIST_API = (trainerId: number) => `${MEMBER_API}/match_waiting-list/${trainerId}`;
...
const SUBSCRIPTION_API = `${MEMBER_API}/subscription`;
const MEMBER_SUBSCRIPTION_API = `${MEMBER_API}/me/subscription`;
const PAYMENT_API = `${MEMBER_API}/payment`;
